...
try {
  ...
  check("the installed extensions are listed", names.length === 7 && ["Library","Focus Timer","Color Themes","Sync & Backup","Bookmarks","Activity Insights","Global Search"].every((n) => names.includes(n)), names.join(", "));
